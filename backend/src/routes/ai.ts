...
If the user hasn't given a date for the event, set needs_date=true, leave event_date null, and ask for the date in your reply. If a date is given or inferable (e.g. "next October", "March 14"), resolve it to an ISO YYYY-MM-DD date — assume the next future occurrence if only a month/day is given — and set needs_date=false.
